...
- No coding agent is given your browser. Sorema does not pass Claude Code `--chrome` and offers no
  command to enable it, because an action on a signed-in site is the one thing your own git history
  cannot undo.
